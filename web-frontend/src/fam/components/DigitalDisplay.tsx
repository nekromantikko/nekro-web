...
export const DigitalDisplay = memo(({ value, length = 3, disabled }: DigitalDisplayProps) => {
    ...
    return (
        <div className="
            inline-flex m-auto items-center justify-center px-2 py-1 rounded-md bg-neutral-800
        ...
        ">
            <div className="relative font-digital font-bold tracking-wider text-l select-none">
